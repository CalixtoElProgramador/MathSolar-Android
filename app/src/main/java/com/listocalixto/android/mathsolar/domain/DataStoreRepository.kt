...
import com.listocalixto.android.mathsolar.app.Constants.PREFERENCES_FIRST_DIALOG_MAP_SEEN
...
class DataStoreRepository @Inject constructor(
    ...
    private object PreferencesKey {
        val wasSeenTheFirstDialogOnTheMap = booleanPreferencesKey(PREFERENCES_FIRST_DIALOG_MAP_SEEN)
        val isLocationPermissionEnabled = booleanPreferencesKey(PREFERENCES_LOCATION_ENABLED)
    }

    private val Context.datastore: DataStore<Preferences> by preferencesDataStore(PREFERENCES_NAME)

    suspend fun saveFirstDialogMapWasSeen(wasSeen: Boolean) = withContext<Unit>(ioDispatcher) {
        context.datastore.edit { preferences ->
            preferences[PreferencesKey.wasSeenTheFirstDialogOnTheMap] = wasSeen
        }
    }

    suspend fun saveIsLocationPermissionEnabled(request: Boolean) =
    ...
    val readFirstDialogMapWasSeen: Flow<Boolean> = context.datastore.data
        .catch { exception ->
        ...
        .map { preferences ->
            val response = preferences[PreferencesKey.wasSeenTheFirstDialogOnTheMap] ?: false
            response
        }
